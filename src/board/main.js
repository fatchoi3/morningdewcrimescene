...
const NOTE = {
  '보드_진행물.html': '시작 시트 · 기본 규칙 · 라운드 트랙 · 이벤트 4장 + 대조 열람권 6장',
  '보드_장소판.html': '현장 판(방마다 번호 자리) + 공개 단서. A3 가로 권장',
  '보드_단서카드.html': '단서 121장 + 특수 8장 + 잠금 4장. V·Q 카드에는 QR. 양면·짧은 쪽 넘김',
  '보드_인물카드.html': '6인 × 4장(프로필·시나리오·대본·상황별 대응) + 7인용 형사 2장. 따로 나눠 줄 것',
