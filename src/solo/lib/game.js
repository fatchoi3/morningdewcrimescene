...
export const ROOM_HOTSPOTS = {
  'ROOM-JH': { // 인물(최종현) 배경 포함 — 좌표는 새 그림(1376×768) 기준
    'TYQD-94': { x: 23, y: 53, s: 0.9 },   // 책상 위 왼쪽 반투명 통(단백질)
    'OYJW-26': { x: 33, y: 52, s: 0.9 },   // 책상 위 오른쪽 반투명 통(요힘빈)
    'HPKM-53': { x: 30, y: 58, s: 0.85 },  // 검은 셰이커 텀블러
    'VNTD-61': { x: 39, y: 59, s: 0.9 },   // 책상 위 서류(등산코스 지도)
    'OIMO-99': { x: 46, y: 55, s: 0.8 },   // 책상 오른쪽
    'EDEZ-28': { x: 41, y: 78, s: 0.95 },  // 책상 아래 수납상자
    'NDVA-68': { x: 37, y: 90, s: 0.95 },  // 바닥 등산화
    'YPYZ-13': { x: 54, y: 78, s: 0.85 },  // 침대 옆 라탄 바구니
    'NMFM-21': { x: 88, y: 63, s: 1 },     // 침대 발치 개어둔 담요
