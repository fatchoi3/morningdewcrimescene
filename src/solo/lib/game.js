...
export const ROOM_HOTSPOTS = {
  'ROOM-JH': { // 인물(최종현) 배경 포함 — 물건 실루엣(poly), 새 그림(1376×768) 기준
    'TYQD-94': { x: 21, y: 51, w: 13, h: 13, poly: [[8, 10], [92, 8], [95, 95], [5, 95]] },                // 왼쪽 반투명 통(단백질)
    'OYJW-26': { x: 31, y: 51, w: 11, h: 12, poly: [[8, 10], [92, 8], [95, 95], [5, 95]] },                // 오른쪽 반투명 통(요힘빈)
    'HPKM-53': { x: 30, y: 58, w: 6, h: 14, poly: [[22, 4], [78, 4], [85, 96], [15, 96]] },                // 검은 셰이커 텀블러
    'VNTD-61': { x: 39, y: 60, w: 16, h: 7, poly: [[4, 25], [96, 12], [97, 80], [3, 92]] },                // 책상 위 서류
    'OIMO-99': { x: 46, y: 59, w: 7, h: 5 },                                                               // 책상 오른쪽(펜)
    'EDEZ-28': { x: 40, y: 78, w: 15, h: 15, poly: [[10, 18], [90, 14], [95, 95], [5, 95]] },              // 책상 아래 수납상자
    'NDVA-68': { x: 37, y: 89, w: 13, h: 12, poly: [[6, 58], [26, 22], [44, 38], [64, 20], [96, 46], [90, 96], [10, 96]] }, // 바닥 등산화
    'YPYZ-13': { x: 54, y: 76, w: 13, h: 19, poly: [[16, 5], [84, 5], [92, 55], [86, 95], [14, 95], [8, 55]] }, // 라탄 바구니
    'NMFM-21': { x: 88, y: 64, w: 19, h: 12, poly: [[4, 20], [96, 10], [97, 86], [3, 94]] },               // 침대 발치 개어둔 담요
    '__talk__': { x: 67, y: 45, s: 1 },                                                                    // 최종현 — 배경 인물(터치로 대화)
  },
  'ROOM-SR': { // 인물(이사랑) 배경 포함 — 물건 실루엣(poly), 새 그림(1376×768) 기준
    'NYBB-98': { x: 21.5, y: 52, w: 9, h: 10, poly: [[10, 30], [30, 8], [70, 8], [90, 30], [95, 70], [80, 95], [20, 95], [5, 70]] }, // 꽃무늬 파우치
    'GLUE-77': { x: 26, y: 54, w: 4, h: 10, poly: [[20, 8], [80, 8], [85, 95], [15, 95]] },                // 초록 딱풀
    'LBPG-31': { x: 32.5, y: 58, w: 12, h: 8, poly: [[8, 20], [92, 12], [95, 85], [3, 92]] },              // 라벨 스티커+볼펜
    'SUIX-89': { x: 41, y: 56, w: 12, h: 9, poly: [[5, 18], [95, 10], [97, 88], [3, 95]] },                // 붉은 글씨 독촉장
    'BCZN-89': { x: 49, y: 53.5, w: 9, h: 8, poly: [[5, 25], [95, 20], [97, 80], [3, 88]] },               // 쌓인 책(다이어리)
    'UJVD-65': { x: 57, y: 68, w: 9, h: 14, poly: [[16, 5], [84, 5], [92, 55], [86, 95], [14, 95], [8, 55]] }, // 바구니(성경책)
    'OLUX-30': { x: 93, y: 43, w: 13, h: 26, poly: [[30, 2], [45, 0], [45, 6], [70, 10], [95, 28], [85, 34], [86, 96], [20, 96], [22, 34], [8, 28], [30, 10]] }, // 옷걸이 가디건
  ...
  'ROOM-HW': { // 인물(박희원) 배경 포함 — 물건 실루엣(poly), 새 그림(1376×768) 기준
    ...
    'LUDP-77': { x: 38, y: 64, w: 6, h: 5, poly: [[20, 10], [80, 10], [95, 50], [80, 92], [20, 92], [5, 50]] }, // 손목시계
    'VJMU-45': { x: 49, y: 53.5, w: 9, h: 9, poly: [[10, 30], [30, 8], [70, 8], [90, 30], [95, 70], [80, 95], [20, 95], [5, 70]] }, // 꽃무늬 화장품 파우치
    'MZKW-75': { x: 50, y: 62, w: 7, h: 6 },                                                               // 책상 앞쪽 다이어리(소품 없음)
    'HTXI-85': { x: 55.5, y: 37, w: 12, h: 20, poly: [[30, 2], [45, 0], [45, 6], [70, 10], [90, 28], [78, 34], [80, 96], [20, 96], [22, 34], [10, 28], [30, 10]] }, // 옷걸이 가디건
    'JAJZ-77': { x: 63.5, y: 73, w: 9, h: 13, poly: [[16, 5], [84, 5], [92, 55], [86, 95], [14, 95], [8, 55]] }, // 바구니(성경책)
    '__talk__': { x: 78, y: 48, s: 1 },                                                                    // 박희원 — 배경 인물(터치로 대화)
  },
  'ROOM-HJ': { // 인물(이현지) 배경 포함 — 물건 실루엣(poly), 새 그림(1376×768) 기준
    'BXNP-29': { x: 29, y: 55, w: 5, h: 10, poly: [[18, 8], [82, 8], [88, 96], [12, 96]] },                // 갈색 약통(졸피뎀)
    'KPVH-32': { x: 40.5, y: 51, w: 10, h: 9, poly: [[10, 30], [30, 8], [70, 8], [90, 30], [95, 70], [80, 95], [20, 95], [5, 70]] }, // 꽃무늬 파우치
    'IJRP-82': { x: 36, y: 59, w: 13, h: 8, poly: [[5, 45], [48, 25], [95, 45], [92, 88], [48, 72], [8, 88]] }, // 펼쳐진 회계 장부
    'BUFL-52': { x: 47, y: 62, w: 7, h: 6 },                                                                // 책상 오른쪽 다이어리(소품 없음)
    'ESQN-14': { x: 57.5, y: 71, w: 9, h: 15, poly: [[16, 5], [84, 5], [92, 55], [86, 95], [14, 95], [8, 55]] }, // 바구니(성경책)
  ...
  'ROOM-GH': { // 인물(이가현) 배경 포함 — 물건 실루엣(poly), 새 그림(1376×768) 기준
    'KTGF-02': { x: 30.5, y: 54, w: 8, h: 9, poly: [[10, 30], [30, 8], [70, 8], [90, 30], [95, 70], [80, 95], [20, 95], [5, 70]] }, // 꽃무늬 파우치
    'NBZL-83': { x: 35.5, y: 59, w: 6, h: 5, poly: [[8, 15], [95, 10], [97, 85], [3, 92]] },               // 지갑
    'PEDR-58': { x: 40, y: 58, w: 5, h: 7, poly: [[12, 8], [88, 5], [92, 92], [8, 95]] },                  // 소아과 영수증
    'AYMX-96': { x: 44, y: 58.5, w: 10, h: 9, poly: [[5, 45], [48, 25], [95, 45], [92, 88], [48, 72], [8, 88]] }, // 펼쳐진 다이어리
    'ZNUS-26': { x: 61, y: 37, w: 13, h: 22, poly: [[30, 2], [45, 0], [45, 6], [70, 10], [90, 28], [78, 34], [80, 96], [20, 96], [22, 34], [10, 28], [30, 10]] }, // 옷걸이 가디건
    'DZPL-78': { x: 61, y: 72, w: 9, h: 13, poly: [[16, 5], [84, 5], [92, 55], [86, 95], [14, 95], [8, 55]] }, // 바구니 성경책(펼치면 아이 그림 LWNR-86)
    'WORR-03': { x: 76, y: 46, w: 6, h: 6 },                                                               // 가현 손등 긁힌 자국(인물 왼쪽, 터치존 바깥)
    '__talk__': { x: 86, y: 48, s: 1 },                                                                    // 이가현 — 배경 인물(터치로 대화)
  },
  'ROOM-EJ': { // 인물(윤은재) 배경 포함 — 물건 실루엣(poly), 새 그림(1376×768) 기준
    'VUDC-50': { x: 35.5, y: 53, w: 11, h: 9, poly: [[6, 25], [92, 12], [96, 78], [3, 95]] },              // 책상 위 빨간 도장 제안서
    'MZVN-14': { x: 45.5, y: 51, w: 10, h: 9, poly: [[4, 50], [30, 22], [50, 35], [70, 22], [96, 50], [90, 88], [50, 72], [10, 88]] }, // 펼쳐진 성경책
    'UHRU-61': { x: 52, y: 51, w: 7, h: 7, poly: [[8, 15], [95, 8], [97, 85], [5, 95]] },                  // 갈색 다이어리
    'LWFJ-99': { x: 31, y: 56, w: 6, h: 5 },                                                               // 책상 앞쪽 약봉투(소품 없음)
