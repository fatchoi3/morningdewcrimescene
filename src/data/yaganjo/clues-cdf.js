...
//     — 그 출처는 C3(준호 재활 일정표) · F5(재활병원 수납 문자) · D4(딸 사진 뒷면)이 각자 들고 있다.
...
export const cluesCDF = {
  ...
  'YTDK-27': {
    ...
    detail: '',
    // 봉함 상태와 뜯은 뒤를 두 쪽으로 나눴다(EBEZ-58 과 같은 꼴). 글은 그대로이고 쪽만 갈랐다 —
    // 봉투 사진과 전표 사진이 따로 있어서다.
    pages: [
      {
        title: '봉함 상태',
        image: '/images/yaganjo/c2-sealed-envelope.jpg',
        content: '흰 봉투 한 장. 겉에는 아무것도 적혀 있지 않다. 입구가 풀로 봉해져 있고 뜯은 자국이 없다.',
      },
      {
        title: '뜯은 뒤',
        image: '/images/yaganjo/c2-card-slips.jpg',
        content: '안에 카드 전표 넉 장이 들어 있다. 날짜가 한 달씩 떨어져 있고, 가맹점 칸에 같은 재활병원 이름이 찍혀 있다.\n넉 장 다 아래 두 줄이 같다 — 결제자 {{S6}} / 환자 오준호.',
      },
    ],
    type: '보통',
    person: '{{S3}}',
  ...
  'GOCI-93': {
    ...
    image: '', // 여권은 안전 필터로 생성 불가 — 카드 문면이 대신한다
    type: '보통',
    person: '{{S4}}',
  },
      ...
      apps: [
        {
          ...
          chats: [
            ...
            },
            {
              name: '[재활병원] 수납안내',
              messages: [
                { from: 'them', text: '[Web발신] 오준호 님(2009.03.14) 진료비 288,000원 수납 완료되었습니다. 결제자 {{S6}}. — 새봄재활의학과의원', time: '넉 달 전 16:22' },
                { from: 'them', text: '[Web발신] 오준호 님(2009.03.14) 진료비 288,000원 수납 완료되었습니다. 결제자 {{S6}}. — 새봄재활의학과의원', time: '석 달 전 16:18' },
                { from: 'them', text: '[Web발신] 오준호 님(2009.03.14) 진료비 288,000원 수납 완료되었습니다. 결제자 {{S6}}. — 새봄재활의학과의원', time: '두 달 전 16:20' },
                { from: 'them', text: '[Web발신] 오준호 님(2009.03.14) 진료비 288,000원 수납 완료되었습니다. 결제자 {{S6}}. — 새봄재활의학과의원', time: '지난달 16:15' },
              ],
            },
            {
              name: '02-***-**** 센터 사무실',
