...
const ROOMS = [
  { x: 55, y: 45, w: 95, h: 70, label: '이사랑', lx: 102, ly: 84 },
  { x: 150, y: 45, w: 95, h: 70, label: '이현지', lx: 197, ly: 84 },
  { x: 245, y: 45, w: 90, h: 70, label: '박희원', lx: 290, ly: 84 },
  { x: 335, y: 12, w: 63, h: 80, label: '목사님', lx: 366, ly: 55, victim: true },
  { x: 55, y: 172, w: 95, h: 73, label: '최종현', lx: 102, ly: 212 },
  { x: 150, y: 172, w: 95, h: 73, label: '이가현', lx: 197, ly: 212 },
  { x: 245, y: 172, w: 90, h: 73, label: '윤은재', lx: 290, ly: 212 },
];
