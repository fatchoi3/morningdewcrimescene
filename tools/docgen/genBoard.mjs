...
function runSheets() {
  ...
  <div class="page">${stage('첫 라운드 전에 · 계속 펴 둡니다')}<h1>기본 규칙 <span class="muted">— 뒷장</span></h1>
    ...
    <h2>「공개한다」는 무엇인가</h2>
    <p>토론에서는 <b>카드를 보여 주지 않고 말로만</b> 공유합니다. 그것이 기본입니다.
      다만 <b>공개</b>는 다릅니다 — <b>그 카드를 판 가운데에 앞면으로 내려놓아 모두가 직접 읽게 하는 것</b>입니다.<br>
      <b>누구든, 자기 차례가 아니어도, 언제든 자기 카드를 공개할 수 있습니다.</b>
      공개한 카드는 다 읽힌 뒤 <b>도로 자기 앞으로 가져갑니다</b> — 내주는 것이 아닙니다.<br>
      <span class="muted">남 앞에 <b>번호만</b> 놓여 있는 것은 공개가 아닙니다. 무엇을 몇 장 가졌는지는
      원래 서로 보이고, 그 내용은 여전히 그 사람 것입니다. 공개는 「이 카드는 내가 읽은 그대로다」를
      보이는 일이라, 말로 하는 주장과 달리 거짓말을 섞을 수 없습니다 — 그래서 값이 있습니다.</span></p>
