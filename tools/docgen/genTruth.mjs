...
<div class="ch">
  ...
  <p>그는 박희원 전도사의 <strong>신학교 수료증이 위조</strong>되었다는 의심을 품기 시작했다. 지인 목사가 "그 전도사 수료증 자격이 의심스럽다"는 카톡을 보내왔기 때문이다. 목사는 박희원에게 <strong>"수련회 끝나면 교단에 알아보겠다"</strong>고 통보했다 — 자신을 죽이려는 동기를 심어준 줄도 모르고.</p>
  <p>재정에서도 이상한 낌새를 느꼈다. 수련회 당일 아침, 목사는 우연히 청년부 통장 내역을 확인했는데 <strong>찬조금이 입금된 기록이 전혀 없었다.</strong> 그는 이사랑 총무와 면담했고, 어물쩍 넘어가려는 그녀의 태도에 <strong>"수련회가 끝나면 재정을 점검해 모든 것을 밝히겠다"</strong>고 했다 — 빚에 쫓기던 그녀를 절망으로 몰아넣는 줄도 모르고.</p>
  <p>가장 결정적으로, 그는 청년 '멋짐교회 김멋짐'과 대화하다 <strong>상대가 이가현의 약혼자인 줄 모르고</strong> "가현이는 애도 있고 곧 결혼한다더라"는 이야기를 흘렸다. 이 한마디가 이가현의 파혼을 불렀다.</p>
  ...
  <div class="box key"><div class="bl">핵심 — 목사는 가짜 약을 알아챘다</div>
    <p>목사는 책상 위 설하정 통에서 약을 하나 꺼내 먹었다. 그런데 <strong>설하정 특유의 딸기 맛이 나지 않았다.</strong> 박희원이 비타민으로 바꿔놓은 것이었다. 이상함을 느낀 목사는 <strong>품에 항상 지니고 다니던 작은 약통에서 진짜 설하정을 꺼내 먹고</strong> 침대에서 안정을 취했다. <strong>"누가 약통을 바꿔놨지?"</strong> 의심하면서. — 그 무력한 순간, 박희원이 들어와 베개로 그를 눌렀다. 목사는 자신이 왜 죽는지도 모른 채 숨을 거뒀다.</p></div>
...
<div class="ch">
  ...
  <div class="cht">박희원<span class="tag" style="background:#FEF6E4;color:#854F0B">주범 · 베개 질식</span></div>
  <div class="role" style="color:#854F0B">28세 · 청년부 전도사</div>
  <p><strong>발단 — 위조가 들통날 위기.</strong> 박희원은 <strong>위조한 신학교 수료증으로 전도사가 되었다.</strong> 그런데 목사의 지인 목사가 "그 전도사 수료증 자격이 의심스럽다, 확인해 봤냐"는 카톡을 보냈고, 목사가 이를 확인하려 들면서 박희원은 위기에 몰렸다. 수련회 전날 면담에서 목사는 <strong>"수련회 끝나면 교단에 직접 알아보겠다"</strong>고 통보했다. 위조가 들통나면 모든 것이 끝이었다.</p>
  ...
  <div class="box key"><div class="bl">직접 사인의 흔적 — 정황 추리형 (시스템이 확정해 주지 않음)</div>
    <p>베개로 얼굴을 누르자 목사는 발작으로 힘이 빠진 손을 본능적으로 들어 올렸고, 그 손이 박희원의 손목을 스치며 <strong>인조가죽 시곗줄에 옅은 자국을 하나</strong> 남겼다. 동시에 <strong>목사의 손톱 밑에는 정체를 알기 어려운 미세한 이물질</strong>이 꼈다. 박희원은 자국을 알아채지 못한 채 시계를 계속 착용한다.<br><br><strong>손톱 밑 이물(목사)·시곗줄의 새 자국(박희원)·이가현의 모기 긁힌 자국</strong>은 서로 직접 연결되거나 확정되지 않는다. 검식도 "이물질이 있다 + 현장과 이질적"까지만 말한다. 참가자가 정황을 스스로 엮어 추론해야 하며, <strong>박희원은 끝까지 부인한다.</strong> 마무리는 운영자의 이 해설로 한다.</p></div>
  <div class="box unknew"><div class="bl">박희원이 몰랐던 진실 — 가장 큰 아이러니</div>
    <p>그는 "내 가짜 약 때문에 발작이 안 멎은 것"이라 생각했지만, 목사가 발작한 진짜 이유는 <strong>이사랑이 바꿔치기한 요힘빈 음료</strong> 때문이었다. 그리고 목사는 가짜 약을 알아채고 진짜 설하정을 따로 먹었기에, 박희원의 약 바꿔치기는 사실상 빗나갔다. <strong>그가 "계획 실패"라 판단해 직접 죽이지 않았다면, 사인은 전혀 다르게 흘러갔을 것이다.</strong> 그가 베개를 누른 것이 직접 사인이 됐다.</p></div>
</div>
...
<div class="ch">
  ...
  <p>그런데 수련회 당일 아침, <strong>목사가 우연히 청년부 통장 내역을 확인하고 찬조금이 입금되지 않은 것을 발견했다.</strong> 목사는 이사랑과 면담했고, 어물쩍 넘어가려는 그녀에게 수련회 후 재정을 점검하겠다고 했다. 빚을 갚으려던 계획이 무너지자 이사랑은 절망에 빠졌다.</p>
  <div class="box key"><div class="bl">전날 밤 — 오해가 풀리던 순간</div>
    <p>수련회 전날, 이사랑은 통장을 정리하다 <strong>언니가 수년째 자기 빚을 몰래 갚아온 송금 내역</strong>을 발견했다. "발 뺀 줄 알았던" 언니가 한 번도 손을 놓지 않았던 것이다. 그날 밤 이사랑은 언니에게 카톡으로 오해를 사과했고, 언니는 상속포기의 진짜 이유를 길게 털어놓았다. <strong>화해가 막 시작된 그 자리에서</strong>, 이사랑은 "목사님이 장부를 보자고 한다"는 위기까지 고백했다.</p></div>
  <div class="sec">범행 — 라벨 교체</div>
  <p>이사랑은 목사를 완전히 죽일 생각까진 없었다. 다만 <strong>"목사가 한 번 쓰러져서 재정 점검이 미뤄지기만 하면"</strong> 하는 마음이었다. 막내 최종현이 위험한 다이어트 보충제 요힘빈을 먹는다는 걸 알고 있던 그녀는, 최종현이 등산 간 사이 그의 방에 들어가 <strong>요힘빈 통과 단백질 통의 라벨지를 바꿔놨다.</strong> 라벨을 오릴 때 흰 가루가 화장품 파우치에 묻었다.</p>
  <div class="box unknew"><div class="bl">이사랑이 몰랐던 진실</div>
    <p>그녀는 요힘빈 발작이 죽음까진 안 갈 거라 생각했다. 목사에게 응급약이 있으니까. 하지만 <strong>박희원이 이미 그 응급약을 가짜로 바꿔놨다는 것</strong>도, <strong>목사를 실제로 죽인 건 베개 질식(박희원)</strong>이라는 것도 몰랐다. 심지어 <strong>친언니 이현지가 같은 날 목사 텀블러에 수면제를 넣었다는 것</strong>조차 몰랐다. 그녀는 "혹시 내 요힘빈 때문인가" 떨지만, 직접 사인은 그녀의 것이 아니다.</p></div>
</div>

<div class="ch">
  <div class="eye" style="color:#0F6E56">독립 범행</div>
  <div class="cht">이현지<span class="tag" style="background:#E8F8F2;color:#0F6E56">수면제 · 사인 무관</span></div>
  <div class="role" style="color:#0F6E56">26세 · 청년부 회계 · 이사랑의 친언니</div>
  <p><strong>동생을 지키려 한 또 하나의 범행.</strong> 이현지는 이사랑의 친언니이자 청년부 회계다. 부모가 빚을 남기고 떠났을 때, 이현지는 <strong>이미 자기 채무가 있었다.</strong> 자신이 상속을 받으면 자기 채권자들이 그 몫까지 가져가 동생이 더 깊이 빠질 상황이었다. 그래서 <strong>법적으로만 상속을 포기</strong>해 동생이 정리할 길을 터줬다 — 그 결과 빚은 동생에게 집중됐고, 동생은 언니가 자기를 버렸다고 오해했다. 하지만 이현지는 <strong>그 뒤로 자기 월급에서 조금씩, 동생 모르게 빚을 갚아왔다.</strong> 한 번도 손을 놓은 적이 없었다.</p>
  <p>이 상처 입은 관계를 둘 다 인정하고 싶지 않아, 같은 교회에 다니면서도 남남처럼 굴었다. 사람들은 그저 '사이 안 좋은 두 임원'으로만 알았다 — 데면데면함 자체가 위장이 됐다. 그런데 전날 밤 동생이 송금 내역을 발견해 오해가 풀렸고, 곧이어 <strong>"목사님이 장부를 보자고 한다, 나 찬조금에 손댔다"는 동생의 위기</strong>를 알게 됐다. 끝내 놓지 못한 동생이 범죄로 무너지려 하자, 이현지는 움직였다.</p>
  <div class="sec">범행 — 텀블러에 수면제</div>
  <p>이현지는 동생과 구체적 방법을 상의하지 않고 독자적으로 움직였다. <strong>목사 책상 위에는 항상 개인 텀블러가 놓여 있었다.</strong> 그녀는 강한 수면제(졸피뎀)를 그 텀블러에 타 넣었다. 목사가 깊이 잠들어 정신을 못 차리면 재정 점검도 흐지부지될 거라 생각했다. 캡슐 포일은 방 휴지통에 버렸다.</p>
  <div class="box unknew"><div class="bl">이현지가 몰랐던 진실 — 허무한 결말</div>
    <p>그녀의 계획은 실행됐지만, <strong>목사는 그 텀블러를 마시기도 전에 죽었다.</strong> 요힘빈 발작과 박희원의 베개 질식이 먼저였기 때문이다. 그녀의 수면제는 사인과 전혀 무관하다. 그녀는 <strong>동생이 같은 날 라벨을 바꿨다는 것</strong>도, <strong>박희원이 목사를 직접 죽였다는 것</strong>도 몰랐다. 자매는 각자 따로, 서로 모르게, 같은 사람을 노렸던 것이다.</p></div>
...
<div class="ch">
  ...
  <p>수련회 당일, 그는 가방을 방에 두고 목사와 등산을 갔다. 돌아온 뒤 방에서 가방을 챙겨 <strong>"단백질"이라 적힌 통</strong>으로 음료를 타 목사에게 드렸다. 그게 진짜 단백질인 줄 알았다. 하지만 그 사이 이사랑이 라벨지를 바꿔놔서, 실제로는 요힘빈이 든 음료였다.</p>
  ...
  <div class="box knew"><div class="bl">진실 — 그는 무고하다</div>
    <p>그는 자기가 목사를 죽였을지 모른다는 공포에 시달리지만, <strong>아무 잘못이 없다.</strong> 라벨을 바꾼 건 이사랑이고, 목사를 실제로 죽인 건 박희원의 베개다. 최종현은 도구로 이용당했을 뿐이다. 성분 분석으로 "라벨이 바뀌었다"는 사실이 밝혀져야 그의 누명이 풀린다. 그는 거짓말을 하지 않는다 — 진실만이 그를 지킨다.</p></div>
</div>
...
<div class="ch">
  ...
  <div class="cht">이가현<span class="tag" style="background:#EEEDFE;color:#534AB7">증거 인멸 · 신고 지연</span></div>
  <div class="role" style="color:#534AB7">25세 · 청년부 회장</div>
  ...
  <p>수련회 당일 14시 47분경, 가현은 목사를 따지러 방에 들어갔다. 그런데 <strong>목사는 이미 죽어 있었다.</strong> (박희원이 떠난 지 3분 뒤였다.) 충격 속에서 그녀는 냉정하게 판단했다 — 이대로면 자신의 비밀과 항의 카톡이 다 드러난다. 그녀는 목사가 평소 쓰던 <strong>비밀번호(결혼기념일 0419)를 알고 있었기에</strong>, 목사 핸드폰의 숨김 폴더(톡서랍)를 열어 <strong>김멋짐과의 험담 대화와 자신의 항의 카톡, 딸 관련 기록을 삭제</strong>한 뒤, 14시 58분에야 119에 신고했다. 진입 시각과 신고 시각의 큰 공백이 그녀를 의심받게 만들었다.</p>
