...
<div class="ch">
  ...
  <div class="note"><div class="note-t">지운 사람이 하나 더 있다 — 서지안</div>
    <p>서지안도 자기 폰에서 대화방 하나를 지웠다. 교단 자격 안내원과 나눈 것으로,
...
<div class="ch">
  ...
  <p>수련회 당일 13시 20분경, 세린은 목사를 따지러 방에 들어갔다. 그런데 <strong>목사는 이미 죽어 있었다.</strong> (서지안이 떠난 지 3분 뒤였다.) 충격 속에서 그녀는 냉정하게 판단했다 — 이대로면 자신의 비밀과 항의 카톡이 다 드러난다. <strong>목사 폰은 지문으로 열린다.</strong> 사망 직후라 손가락을 대자 그대로 열렸고, 그녀는 카카오톡에서 <strong>김멋짐과의 험담 대화와 자신의 항의 카톡을 삭제</strong>한 뒤 13시 31분에야 119에 신고했다. 지우는 데는 비밀번호가 필요 없다 — 열려 있으면 그만이다. (되살리려면 톡서랍 비번 <strong>0419</strong>가 필요하고, 그 숫자는 목사 일기장 <code>PRBO-03</code>의 "결혼기념일 4월 19일"에서 나온다. 세린은 그 번호를 몰라도 됐다.) 진입 시각과 신고 시각의 큰 공백이 그녀를 의심받게 만들었다.</p>
