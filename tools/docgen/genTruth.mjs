...
<div class="ch">
  ...
  <p>가장 결정적으로, 그는 청년 '멋짐교회 김멋짐'과 대화하다 <strong>상대가 문세린의 약혼자인 줄 모르고</strong> "세린이는 애도 있고 곧 결혼한다더라"는 이야기를 흘렸다. 이 한마디가 문세린의 파혼을 불렀다.</p>
  ...
  <div class="box key"><div class="bl">핵심 — 목사는 가짜 약을 알아챘다</div>
    <p>목사는 책상 위 설하정 통에서 약을 하나 꺼내 먹었다. 그런데 <strong>설하정 특유의 딸기 맛이 나지 않았다.</strong> 서지안이 비타민으로 바꿔놓은 것이었다. 이상함을 느낀 목사는 <strong>품에 항상 지니고 다니던 작은 약통에서 진짜 설하정을 꺼내 먹고</strong> 침대에서 안정을 취했다. <strong>"누가 약통을 바꿔놨지?"</strong> 의심하면서. — 그 무력한 순간, 서지안이 들어와 베개로 그를 눌렀다. 목사는 자신이 왜 죽는지도 모른 채 숨을 거뒀다.</p></div>
...
<div class="ch">
  ...
  <div class="box key"><div class="bl">직접 사인의 흔적 — 정황 추리형 (시스템이 확정해 주지 않음)</div>
    <p>베개로 얼굴을 누르자 목사는 발작으로 힘이 빠진 손을 본능적으로 들어 올렸고, 그 손이 서지안의 손목을 스치며 <strong>인조가죽 시곗줄에 옅은 자국을 하나</strong> 남겼다. 동시에 <strong>목사의 손톱 밑에는 정체를 알기 어려운 미세한 이물질</strong>이 꼈다. 서지안은 자국을 알아채지 못한 채 시계를 계속 착용한다.<br><br><strong>손톱 밑 이물(목사)·시곗줄의 새 자국(서지안)·문세린의 모기 긁힌 자국</strong>은 서로 직접 연결되거나 확정되지 않는다. 검식도 "이물질이 있다 + 현장과 이질적"까지만 말한다. 참가자가 정황을 스스로 엮어 추론해야 하며, <strong>서지안은 끝까지 부인한다.</strong> 마무리는 운영자의 이 해설로 한다.</p></div>
...
<div class="ch">
  ...
  <p><strong>동생을 지키려 한 또 하나의 범행.</strong> 한소미는 한다영의 친언니이자 청년부 회계다. 부모가 빚을 남기고 떠났을 때, 한소미는 <strong>이미 자기 채무가 있었다.</strong> 자신이 상속을 받으면 자기 채권자들이 그 몫까지 가져가 동생이 더 깊이 빠질 상황이었다. 그래서 <strong>법적으로만 상속을 포기</strong>해 동생이 정리할 길을 터줬다 — 그 결과 빚은 동생에게 집중됐고, 동생은 언니가 자기를 버렸다고 오해했다. 하지만 한소미는 <strong>그 뒤로 자기 월급에서 조금씩, 동생 모르게 빚을 갚아왔다.</strong> 한 번도 손을 놓은 적이 없었다.</p>
...
<div class="ch">
  ...
  <p><strong>하필 최악의 순간에 화를 낸 사람.</strong> 강지후는 찬양팀장이다. 찬양곡 선정 문제로 목사와 오래 갈등해왔다. 그의 기획안은 두 번이나 반려됐고, 감정이 쌓여 있었다.</p>
  ...
  <p>점심 직후 12시 41분경, 그는 복도에서 목사가 방으로 들어가는 걸 보고 따라 들어가 따졌다. 언쟁이 격해지자 <strong>목사의 멱살을 잡았고</strong>, 목사가 "이거 놓으라"며 <strong>지후의 손목을 잡고 가볍게 뿌리치는</strong> 과정에서 지후 손목에 멍이 들고 셔츠 단추 하나가 떨어졌다. 큰 몸싸움은 아니었다. 12시 45분경 그는 문을 쾅 닫고 나왔고, 그가 나올 때까지 <strong>목사는 멀쩡했고 아직 요힘빈 음료를 마시기 전이었다.</strong></p>
  <div class="box knew"><div class="bl">진실 — 그는 무고하다</div>
...
<div class="ch">
  ...
  <p><strong>죽은 사람을 발견하고, 신고 대신 비밀을 지운 사람.</strong> 문세린에겐 숨겨온 비밀이 있었다 — 이혼 경력과 다섯 살 딸. 그녀는 딸을 "조카"라 속이며 살아왔다. 그녀의 약혼자는 같은 교회 청년 '김멋짐'이었다.</p>
  <p>그런데 목사가 김멋짐에게 (상대가 세린의 약혼자인 줄 모르고) "세린이는 애도 있고 곧 결혼한다더라"고 흘렸다. 충격받은 김멋짐은 세린에게 파혼을 통보했다. 분노한 세린은 목사에게 <strong>"당신 때문에 이렇게 됐잖아요!"</strong>라는 카톡을 보냈다.</p>
  <div class="sec">당일 — 이미 죽어 있던 목사</div>
  <p>수련회 당일 13시 20분경, 세린은 목사를 따지러 방에 들어갔다. 그런데 <strong>목사는 이미 죽어 있었다.</strong> (서지안이 떠난 지 3분 뒤였다.) 충격 속에서 그녀는 냉정하게 판단했다 — 이대로면 자신의 비밀과 항의 카톡이 다 드러난다. <strong>목사 폰 자체는 사망 직후라 지문으로 열렸고</strong>, 카카오톡 <strong>숨김 폴더(톡서랍)만 비밀번호로 잠겨</strong> 있었다. 그 비번이 목사의 <strong>결혼기념일 0419</strong>(일기장 <code>PRBO-03</code>에서 유도)임을 알던 그녀는 톡서랍을 열어 <strong>김멋짐과의 험담 대화와 자신의 항의 카톡을 삭제</strong>한 뒤, 13시 31분에야 119에 신고했다. (0419는 폰 잠금이 아니라 톡서랍 비번이다.) 진입 시각과 신고 시각의 큰 공백이 그녀를 의심받게 만들었다.</p>
  <div class="box key"><div class="bl">역설 — 그녀만 아는 결정적 진실</div>
    <p>그녀는 <strong>누가 목사를 죽였는지 모른다.</strong> 들어갔을 때 이미 죽어 있었으니까. 하지만 역설적으로 그녀는 결정적 단서를 쥐고 있다 — <strong>"내가 들어갔을 때 방엔 아무도 없었고, 목사는 이미 죽어 있었다."</strong> 그녀의 진입 시각을 역산하면, 그 직전에 누군가(서지안)가 다녀갔다는 게 드러난다. 그녀의 증거 인멸은 자기 비밀을 지키기 위한 것이었지, 살인과는 무관하다. (목사 일기장의 "결혼기념일 4월 19일" 기록이 톡서랍 비번 0419를 푸는 열쇠가 된다.)</p></div>
</div>
...
<div class="ch">
  ...
  <div class="tl">
    ...
    <div class="tl-row"><div class="tl-t">12:41~45</div><div class="tl-x"><strong>강지후</strong> 목사 방 언쟁 — 멱살 잡음 → 목사가 "놓으라"며 지후 손목 잡고 뿌리침(손목 멍) → 퇴장. 이때 목사는 아직 음료 미복용 · 멀쩡함. (가벼운 실랑이, 질식과 무관)</div></div>
    ...
    <div class="tl-row"><div class="tl-t">13:20</div><div class="tl-x"><strong>문세린</strong> 발견 진입 → 이미 사망 → 목사 폰(0419) 기록 삭제.</div></div>
